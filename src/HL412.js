    ...
    const chartConfig = {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [10, 40, 80, 90, 60, 70, 0], // Replace with percentage data
  ...
  return (
    <div className="room-container">
      <div className="room-content">
        <h1 className="room-title">412 HL</h1>
        <h2 className="room-subtitle">Fourth Floor Hillman Library</h2>
      ...
      <img
        ...
        src={`${process.env.PUBLIC_URL}/photos/hillman_public.png`} 
        alt="lower lounge"
      />
